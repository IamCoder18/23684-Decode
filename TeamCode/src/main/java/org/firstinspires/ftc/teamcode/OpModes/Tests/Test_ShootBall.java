...
public class Test_ShootBall extends LinearOpMode {
	...
	public void runOpMode() throws InterruptedException {
		...
		telemetry.addData("Controls", "A=Align Only, B=Align+Shoot, X=Stop, Y=Status");
		telemetry.update();
		...
		while (opModeIsActive()) {
			...
			org.firstinspires.ftc.teamcode.Subsystems.Spindexer.getInstance().update();
