 ...
 * Minimal usage:<br>
 * PIDFController pid = new PIDFController(p,i,d); <br>
 * ...looping code...{ <br>
...
public class PIDFcontroller {
    ...
    /**
     * Create a PIDFController class object.
     ...
     * @see PIDFController#getOutput(actual) <br>
     * @param setpoint
     */
     ...
     * @see PIDFController#setSetpoint()
     * @param actual The monitored value, typically as a sensor input.
     * @param setpoint The target value for the system
     * @return calculated output value for driving the system
     */
