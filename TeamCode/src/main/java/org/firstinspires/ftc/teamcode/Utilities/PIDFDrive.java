...
PIDFController  pidfX;
PIDFController  pidfY;
PIDFController pidfH;
...
public PIDFDrive(HardwareMap hw, Localizer local) {
    ...
    pidfX = new PIDFController(Xp,Xi,Xd,Xf);
    pidfY = new PIDFController(Yp,Yi,Yd,Yf);
    pidfH = new PIDFController(Hp,Hi,Hd,Hf);

    pidfX.setPID(Xp,Xi,Xd,Xf);
    pidfY.setPID(Yp,Yi,Yd,Yf);
    pidfH.setPID(Hp,Hi,Hd,Hf);
}
...
public void setPIDX(double p, double i, double d, double f){
    Xp = p;
    Xi = i;
    Xd = d;
    Xf = f;
}
public void setPIDY(double p, double i, double d, double f){
    Yp = p;
    Yi = i;
    Yd = d;
    Yf = f;
}
public void setPIDH(double p, double i, double d, double f){
    Hp = p;
    Hi = i;
    Hd = d;
    Hf = f;
