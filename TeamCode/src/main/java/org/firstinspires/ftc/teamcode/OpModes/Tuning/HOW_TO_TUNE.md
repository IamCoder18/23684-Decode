...
This guide explains how to tune robot subsystems using the dedicated Tuning OpModes. Tuning is for *
*optimization** - adjusting parameters to achieve the best performance. Use tuning when you have
time to experiment and fine-tune values, not during competition.
